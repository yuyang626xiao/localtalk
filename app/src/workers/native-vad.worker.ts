// Ported verbatim from Sokuji src/lib/local-inference/workers/native-vad.worker.ts
// (AGPL-3.0, © Kizuna AI Lab). Import paths adjusted to this app's layout.
/**
...
import type { VadWebConfig } from './_shared/vadConfig';
